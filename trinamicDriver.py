...
#motorport2 = 21 # Motor GPIO enable port number 21 for driver #2 on Raspberry Pi 3
...
class TrinamicDriver():
    ...
    def __init__(self, name='motor', masterspi=True, spiChannel=0, mode=3, datarate=1000000, cslow=True, datacount=32,
            resetpin=2, drvenpin=12, clockpin=4, clockfrequ=None, pigp={}, motordef=None, loglvl=logging.INFO):
        """

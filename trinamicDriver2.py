...
motorport2 = 23 # Motor GPIO enable port number 21 for driver #2 on Raspberry Pi 3
...
class TrinamicDriver2():
    ...
    """
    def __init__(self, name='motor', masterspi=True, spiChannel=1, mode=3, datarate=1000000, cslow=True, datacount=32,
            resetpin=2, drvenpin=23, clockpin=4, clockfrequ=None, pigp={}, motordef=None, loglvl=logging.INFO):
        """
        Initialises the tmc5160
